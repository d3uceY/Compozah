...
export const WIDGET_CATALOG: WidgetInfo[] = [
  { type: 'today_consumption', name: "Today's Consumption", description: 'Large KPI number showing today\'s total.', icon: '📊' },
  { type: 'hourly_trend', name: 'Hourly Trend', description: 'Line chart of hourly consumption.', icon: '📈' },
  { type: 'daily_trend', name: 'Daily Trend', description: 'Bar chart of daily aggregates.', icon: '📊' },
  { type: 'weekly_comparison', name: 'Weekly Comparison', description: 'Compare week-over-week by machine.', icon: '📋' },
  { type: 'monthly_trend', name: 'Monthly Trend', description: 'Line chart of monthly aggregates.', icon: '📈' },
  { type: 'machine_comparison', name: 'Machine Comparison', description: 'Side-by-side machine bars.', icon: '🖥️' },
  { type: 'pie_chart', name: 'Pie Chart', description: 'Distribution pie chart.', icon: '🥧' },
  { type: 'gauge', name: 'Gauge', description: 'Current value within a range.', icon: '⏲️' },
  { type: 'data_table', name: 'Data Table', description: 'Raw data with sorting.', icon: '📋' },
  { type: 'kpi', name: 'KPI Card', description: 'Single key performance indicator.', icon: '🎯' },
  { type: 'efficiency', name: 'Efficiency', description: 'Efficiency percentage display.', icon: '📊' },
  { type: 'cost', name: 'Cost', description: 'Cost calculation and trend.', icon: '💰' },
  { type: 'forecast', name: 'Forecast', description: 'Predicted future trend.', icon: '🔮' },
];
